...
INSERT INTO `sys_menu` VALUES ('1075', '人员审核', '0', '2', '#', 'menuItem', 'M', '0', null, 'fa fa-group', 'admin', '2022-02-21 19:04:00', '', null, '');
...
INSERT INTO `sys_role` VALUES ('3', '求职者', 'job_wanted', '3', '1', '1', '1', 'admin', '2020-02-05 11:25:28', 'admin', '2020-02-08 13:47:12', '');
INSERT INTO `sys_role` VALUES ('4', '企业', 'enterprise', '4', '1', '1', '1', 'admin', '2020-02-05 11:25:48', 'admin', '2020-02-10 13:58:33', '');
INSERT INTO `sys_role` VALUES ('5', '游客', 'tourist', '5', '1', '1', '1', 'admin', '2020-02-05 11:26:13', 'admin', '2022-03-21 20:38:49', '');
INSERT INTO `sys_role` VALUES ('6', '项目专员', 'project', '3', '1', '1', '1', 'admin', '2022-03-21 20:27:01', '', null, null);
INSERT INTO `sys_role` VALUES ('7', '贫困人员', 'poor', '3', '1', '0', '0', 'admin', '2022-03-22 14:57:51', '', null, null);
...
INSERT INTO `sys_role_menu` VALUES ('7', '1109');
INSERT INTO `sys_role_menu` VALUES ('7', '1110');
...
CREATE TABLE `sys_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `identification_card` varchar(30) DEFAULT NULL COMMENT '身份证号',
  `registered_residence` varchar(200) DEFAULT NULL COMMENT '户籍地址',
  `content` longtext COMMENT '情况说明',
  `audit` int(6) DEFAULT NULL COMMENT '审核状态 0：待审核 1：已审核 2：审核未通过 3：脱贫',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', '0', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2022-02-22 15:20:26', 'admin', '2018-03-16 11:33:00', 'ry', '2022-02-22 15:20:25', '管理员', null, null, null, null, null);
INSERT INTO `sys_user` VALUES ('18', null, '0', 'lquans', 'lquans', '01', '', '15810607110', '0', '', '123456', 'bfb3c4', '0', '0', '', null, 'admin', '2022-03-22 15:49:42', '', null, null, '34032312323232', '北京', null, null, '北京 东城区志愿者');
...
CREATE TABLE `t_donate` (
  ...
  `audit_id` int(5) DEFAULT NULL COMMENT '审核人员id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='捐款';
...
INSERT INTO `t_donate` VALUES ('4', 'admin', '1581096', '110@qq.com', '北京', null, '0', null, '111', '202203221114692', '2022032222001484830503617553', null, '0', '', '2022-03-22 11:14:32', '', null, '0', null);
