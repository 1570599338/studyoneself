    ...
    layuimini = new function () {
                ...
                success: function(data, status) {
                   ...
                   var dataObj ;
                    if (data == null) {
                        ...
                        layuimini.initHome(dataObj.homeInfo);
                        layuimini.initLogo(dataObj.logoInfo);
                        layuimini.initClear(dataObj.clearInfo);
                        layuimini.initMenu(dataObj.menuInfo);
                        layuimini.initTab();
                    }
                }
            }).fail(function () {
        ...
        this.initMenu = function (data) {
            ...
            $.each(data, function (key, val) {
                headerMenuHtml += '<li class="layui-nav-item ' + headerMenuCheckDefault + '" id="' + val.title + 'HeaderId" data-menu="' + val.title + '"> <a href="javascript:;"><i class="' + val.icon + '"></i> ' + val.title + '</a> </li>\n';
                headerMobileMenuHtml += '<dd><a href="javascript:;" id="' + key + 'HeaderId" data-menu="' + key + '"><i class="' + val.icon + '"></i> ' + val.title + '</a></dd>\n';
                leftMenuHtml += '<ul class="layui-nav layui-nav-tree layui-left-nav-tree ' + leftMenuCheckDefault + '" id="' + val.title + '">\n';
                        ...
                        var buildChildHtml = function (html, child, menuParameId) {
                            ...
                            $.each(child, function (childIndex, childMenu) {
                                ...
                                if (childMenu.child != undefined && childMenu.child != []) {
                                    ...
                                    html += '<a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"  data-tab-mpi="m-p-i-' + menuParameId + '" data-tab="' + childMenu.href + '" data-source="'+ childMenu.source +'" target="' + childMenu.target + '"><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu.title + '</span></a>\n';
                                    menuParameId++;
